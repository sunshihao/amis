...
export interface Debug {
     ...
     * 鼠标移动时的回调，主要用于调试
     */
    mousePositionTracker?: (x: number, y: number, hitTestResult: HitTestResult | null) => void;
}
export interface ExcelRenderOptions extends RenderOptions, RowColHeadersOptions, GridLineOptions, SelectionOptions, Debug {
    /**
